...
process.on('uncaughtException', (err) => {
    ...
    try {
        dialog.showErrorBox('Dynaxis Labs Studios — Unexpected Error', err && err.stack ? err.stack : String(err));
    } catch (_) {
...
app.whenReady().then(() => {
    ...
    try {
        ...
        dialog.showErrorBox(
            ...
            `Dynaxis Labs Studios started, but local model support failed to initialize:\n\n${err.message}`
        );
    }

...
/**
 * Select which Character reference Assets feed a generation.
 * Authoritative selection is Asset IDs.
 */
export default function CharacterReferencePicker({
  assets = [],
  selectedAssetIds = [],
  onChange,
  maxImages = 1,
  ...
  if (!list.length) {
    return React.createElement(
      ...
      'No Character reference images. Add references in Character Studio or generate a portrait first.'
    );
  }

...
Branch: `phase-7c/tanstack-query-foundation` (base `8cf88bb`).
...
`WP-7C-19` remains backlog until `WP-7C-18` is integrated. `WP-7C-18` is in review and not started on main.

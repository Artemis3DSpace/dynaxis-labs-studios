...
export function authorizeDynaxis(input = {}) {
  ...
  if (definition.policyLayer === 'workspace') {
  ...
  if (definition.requiredProject && projectIsMissing(input.project)) {
  ...
  return decision(input, EXPLICIT_DENY, { matchedPolicy: definition.policyLayer });
}
